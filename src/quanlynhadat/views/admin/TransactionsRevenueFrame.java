...
public class TransactionsRevenueFrame extends javax.swing.JDialog {
    ...
    private void show1() {
        ...
        for (int i = 0; i < list.size(); i++) {
            String type = "";
            if (list.get(i).getT_type().equalsIgnoreCase("cao cấp")==true || list.get(i).getT_type().equalsIgnoreCase("thuong") ==true) {
                type = "Giao dịch nhà";
            } else if (list.get(i).getT_type().equalsIgnoreCase("A")==true || list.get(i).getT_type().equalsIgnoreCase("B") ==true ||list.get(i).getT_type().equalsIgnoreCase("C")== true){
                type = "Giao dịch đất";
            } else {
                type = "Không xác định";
            }
    ...
    //lấy ra các năm trong file để thêm vào combobox Year
