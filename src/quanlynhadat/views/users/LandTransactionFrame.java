...
public class LandTransactionFrame extends javax.swing.JFrame {
    ...
    private void tbGDDatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbGDDatMouseClicked
        DefaultTableModel tableModel = (DefaultTableModel) tbGDDat.getModel(); // lấy dữ liệu ở bảng tbGDDat và ép kiểu thành default
        Vector<Object> v = (Vector<Object>) tableModel.getDataVector().elementAt(tbGDDat.getSelectedRow());
        Transaction t = null;
            try {
                t  = LandTransactionController.getTransactionByUser(idUser, Integer.parseInt(v.get(1).toString())); // v.get có kiểu dữ liệu là object
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (txtMaDG.getText().trim().compareTo("") != 0) { // loại bỏ khoảng trắng đầu , cuối chuỗi
        ...
        if (txtDonGia.getText().trim().compareTo("") == 0) { // chứa đối tượng phụ thuộc, nội dung trong thông báo , tên thông báo , loại nút hiển thị , biểu tượng hiển thị
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (responseConfirm == JOptionPane.YES_OPTION) {
            ...
            DefaultTableModel model = (DefaultTableModel) tbGDDat.getModel(); // lấy dữ liệu ra để sử dụng được phương thức setrowcount
            model.setRowCount(0); // xóa hết dòng đang có trong bảng
            formWindowOpened(null); // load lại dữ liệu bằng cách gọi lại sự kiện loadwindow với không có thêm tham số nào truyền vào 
        }
        btnResetActionPerformed(null);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        List<Transaction> transactions = null; // ấn vào màn hình tổng chuột phải even -> window -> windowOpened
        try{
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if ("".equals(txtTimKiem.getText().trim()) || txtTimKiem == null) {
                ...
                try {
                    ...
                    SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
                    DefaultTableModel model = (DefaultTableModel) tbGDDat.getModel();
                    model.getDataVector().removeAllElements(); // xóa hết dữ liệu trong vector đã lấy ra khi duyệt màn hình
                    model.fireTableDataChanged(); // thông báo cho table phải cập nhật lại dữ liệu
